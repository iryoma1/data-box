...
ActiveRecord::Schema.define(version: 2020_12_04_052123) do
  ...
  create_table "user_scenes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "scene_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["scene_id"], name: "index_user_scenes_on_scene_id"
    t.index ["user_id"], name: "index_user_scenes_on_user_id"
  end
